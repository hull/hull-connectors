...
babel packages                          -d dist                                       --root-mode upward --verbose --copy-files --ignore "packages/connectors/*/src/**","packages/connectors/*/test/**","packages/hull-vm/src/**","packages/hull-webhooks/src/**","packages/hull-sql/src/**"
