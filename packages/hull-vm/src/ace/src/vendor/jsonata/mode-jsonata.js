...
ace.define(
  ...
  function(require, exports, module) {
    ...
    let jsonataFunctions = Object.keys(jsonata.functions);
    ...
    const JSONataHighlightRules = function() {
      const keywordMapper = this.createKeywordMapper(
        {
          "keyword.operator": "and|or|in",
