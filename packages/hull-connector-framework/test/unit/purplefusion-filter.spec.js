...
describe("Outgoing Event Filtering Tests", () => {
  ...
  it("should send outgoing user containing events against empty attributes changes", () => {
    const context = new ContextMock({
      private_settings: {
        synchronized_user_segments: ["ALL"],
        ...
        outgoing_user_events: ["all_events", "user_merged"]
      }
    });
    expect(
      toSendMessage(context, "user", {
