          ...
          externalApiMock: () => {
            ...
            scope
              ...
              .query(query => {
                return (
                  query.q &&
                  query.q.match("FROM Account") &&
                  !query.q.match("AND Website != null")
                );
              })
              .reply(
                200,
            ...
            scope
              ...
              .query(query => {
                return (
                  ...
                  query.q.match("FROM Account") &&
                  query.q.match("AND Website != null") &&
                  query.q.match("AND CustomField1 != null")
                );
              })
              .reply(
                200,
                  ...
                  records: [
                    ...
                    },
                    {
                      attributes: {
                        type: "Account",
                        url:
                          "/services/data/v39.0/sobjects/Account/0011I000007Cy18QAD"
                      },
                    ...
                    },
                    {
                      attributes: {
                        type: "Account",
                        url:
                          "/services/data/v39.0/sobjects/Account/0011I000007Cy18QAE"
                      },
