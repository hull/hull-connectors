          ...
          scope
            ...
            .reply(200, { records: [
                ...
                },
                {
                  attributes: {
                    type: "Account",
                    url: "/services/data/v39.0/sobjects/Account/accoundId2342"
                  },
                  Id: "accoundId2342",
                  Website: "krakowtraders.pl",
                  Name: "Krakow Trades",
      ...
      return {
        ...
        externalApiMock: () => {
          ...
          scope
            .get("/services/data/v39.0/query")
            .query((query) => {
              return query.q && query.q === "SELECT FirstName, LastName, Email, Id, AccountId FROM Contact WHERE Email IN ('adam.pietrzyk@krakowtraders.pl', 'rafa.kasczka@krakowtraders.pl') ORDER BY CreatedDate ASC LIMIT 10000";
            })
            .reply(200, { records: [
                {
                  attributes: {
