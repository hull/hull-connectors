...
const private_settings = {
  ...
  contact_claims: [{ hull: "email", service: "Email", required: false }]
};
        ...
        return {
          ...
          logs: [
            ...
            [
              ...
              {
                error:
                  'Outgoing Batch Error: ERROR_HTTP_400: {"message":"some random error"}',
  ...
  it("should insert a new contact and update an existing account", () => {
    const connector = {
      private_settings: {
        ...
        contact_claims: [
          { hull: "email", service: "C_Email__c", required: true }
        ],
          ...
          externalApiMock: () => {
            ...
            nock("https://na98.salesforce.com")
              .post("/services/Soap/u/39.0", body => {
                return (
                  body.indexOf(
                    "<create><sObjects><type>Contact</type><C_Email__c>adam.pietrzyk@krakowtraders.pl</C_Email__c><FirstName>Adam</FirstName><LastName>Pietrzyk</LastName>"
                  ) !== -1
                );
              })
            ...
            const respBody = createSoapEnvelope("updateResponse", {
              result: [{ id: "ahfidugi123", success: "true" }]
            });
            nock("https://na98.salesforce.com")
              .post("/services/Soap/u/39.0", body => {
                return (
