        ...
        return {
          ...
          externalApiMock: () => {
            ...
            const respBodyC1 = createSoapEnvelope("createResponse", {
              result: [
                { id: "00Q1I000004WO7uUAG", success: "true" },
                { id: "0031I000004SLT3QAO", success: "true" }
              ]
            });
            nock("https://na98.salesforce.com")
              .post("/services/Soap/u/39.0", body => {
                return (
                  body.indexOf(
                    "<create><sObjects><type>Contact</type><Email>adam.pietrzyk@krakowtraders.pl</Email><FirstName>Adam</FirstName><LastName>Pietrzyk</LastName>"
                  ) !== -1
                );
              })
