      ...
      ({ handlers, nock, expect }) => {
        return {
          ...
          externalApiMock: () => {
            ...
            scope.get("/services/data/v39.0/sobjects/Account/describe").reply(
              200,
              {
                fields: [
                  {
                    name: "ACCOUNT_SEGMENTS__c",
                    picklistValues: ["AcntSegment1", "AcntSegment2"],
                    type: "multipicklist",
                    unique: false,
                    updateable: true
                  },
                  ...
                  records: [
                    {
                      ...
                      ACCOUNT_STAGES__c:
                        "Open;Closed;PROSPECTing;Promising;Needs Analysis",
                      ACCOUNT_RANDOM_PL__c:
                        "Appointment scheduled;Qualified to buy;Sent;Won;Lost"
                    }
                  ],
                  done: true
                },
          ...
          messages: [
            {
              ...
              account: {
                ...
                _sales_business_won: "2017-10-25T12:45:00Z",
                cs_stage: "Pending",
                "salesforce_main/id": "0011I000007Cy18QAC",
                "salesforce_main/account_segments_concat": "accountsegment1",
                "salesforce_main/account_stages": [
                  "Closed",
                  "prospecting",
                  "needs analysis",
                  "open",
              ...
              changes: {
                ...
                segments: {},
                account: {
                  account_name: ["old name", "new name"],
                  "outreach/account_stage": ["old stage", "new stage"]
                },
                account_segments: {},
                is_new: false
              }
          ...
          logs: [
            ...
            expect.arrayContaining([
              "ship.service_api.request",
              {
                ...
                url_length: 73,
                url:
                  "https://na98.salesforce.com/services/data/v39.0/sobjects/Account/describe"
              }
            ]),
            [
              "info",
              ...
              },
              {
                record: {
                  ...
                  ACCOUNT_RANDOM_PL__c:
                    "Appointment scheduled;Decision maker bought-in;lost;qualified to buy;won",
                  Id: "0011I000007Cy18QAC"
                },
                operation: "update",
                resource: "Account"
          ...
          logs: [
            ...
            expect.arrayContaining([
              "ship.service_api.request",
              {
                ...
                url_length: 255,
                url:
                  "https://na98.salesforce.com/services/data/v39.0/query?q=SELECT%20Website%2C%20Name%2C%20Mrr__c%2C%20CS_Stage__c%2C%20Id%2C%20CustomField1%20FROM%20Account%20WHERE%20Website%20LIKE%20'%25krakowtraders.pl%25'%20ORDER%20BY%20CreatedDate%20ASC%20LIMIT%2010000"
              }
            ]),
            [
              "info",
            ...
            scope
              ...
              .query(query => {
                return (
                  query.q &&
                  query.q ===
                    "SELECT KYB_validate_at__c, contract_signed_at__c, Last_Load_Date__c, Description, Id, Website FROM Account WHERE Website LIKE '%apple.com%' ORDER BY CreatedDate ASC LIMIT 10000"
                );
              })
              .reply(
                200,
          ...
          messages: [
            {
              ...
              account: {
                anonymous_ids: ["salesforce:0011tAAAAAA"],
                domain: "apple.com",
                id: "a9461ad518be40ba-b568-4729-a676-f9c55abd72c9",
                name: "Apple",
          ...
          logs: [
            ...
            expect.arrayContaining([
              "ship.service_api.request",
              {
                ...
                url_length: 282,
                url:
                  "https://na98.salesforce.com/services/data/v39.0/query?q=SELECT%20KYB_validate_at__c%2C%20contract_signed_at__c%2C%20Last_Load_Date__c%2C%20Description%2C%20Id%2C%20Website%20FROM%20Account%20WHERE%20Website%20LIKE%20'%25apple.com%25'%20ORDER%20BY%20CreatedDate%20ASC%20LIMIT%2010000"
              }
            ]),
            [
              "info",
              ...
              {
                reason:
                  "The account in Salesforce is already in sync with Hull."
              }
            ],
            [
              "info",
