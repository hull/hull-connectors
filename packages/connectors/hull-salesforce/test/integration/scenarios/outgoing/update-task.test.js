    ...
    return testScenario({ connectorConfig }, ({ handlers, nock, expect }) => {
      return {
        ...
        externalApiMock: () => {
          ...
          const respBodyC1 = createSoapEnvelope("createResponse", { result: [{ id: "asdfasdf", success: "true" }] });
          nock("https://na98.salesforce.com")
            .post("/services/Soap/u/39.0", (body) => {
              return body.indexOf("" +
                "<create>" +
          ...
          const respBodyC2 = createSoapEnvelope("createResponse", { result: [{ id: "aOuvlns903760", success: "true" }] });
          nock("https://na98.salesforce.com")
            .post("/services/Soap/u/39.0", (body) => {
              return body.indexOf("" +
                "<create>" +
            ...
            .reply(200, respBodyC2, { "Content-Type": "text/xml", "sforce-limit-info": "api-usage=500/50000" });
          return scope;
        },
        connector,
        messages: [
        ...
        logs: [
          ...
          expect.arrayContaining([
            "ship.service_api.request",
            {
              "method": "GET",
              "url_length": 70,
              "url": "https://na98.salesforce.com/services/data/v39.0/sobjects/Task/describe"
            }
          ]),
          expect.arrayContaining([
            "ship.service_api.request",
            {
              "method": "GET",
              "url_length": 158,
              "url": "https://na98.salesforce.com/services/data/v39.0/query?q=SELECT%20%20FROM%20Task%20WHERE%20ExternalEventId__c%20IN%20('hubspot_email_3'%2C%20'hubspot_email_4')"
            }
          ]),
          [
            "info",
