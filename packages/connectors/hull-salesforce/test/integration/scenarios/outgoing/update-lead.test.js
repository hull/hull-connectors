      ...
      return {
        ...
        externalApiMock: () => {
                ...
                records: [
                  ...
                  },
                  {
                    attributes: {
                      type: "Lead",
                      url:
                        "/services/data/v39.0/sobjects/Lead/00Q1I000004WHchUAG"
                    },
          ...
          const respBody = createSoapEnvelope("updateResponse", {
            result: [{ id: "00Q1I000004WO7uUAG", success: "true" }]
          });
        ...
        logs: [
          ...
          expect.arrayContaining([
            "outgoing.job.progress",
            {
              ...
              sfContacts: 0,
              sfAccounts: 0,
              userIds: ["5a43ce781f6d9f471d005d44"],
              userEmails: ["adam.pietrzyk@krakowtraders.pl"],
              accountDomains: []
            }
          ]),
          expect.arrayContaining([
          ...
          expect.arrayContaining([
            "ship.service_api.request",
            {
              ...
              url_length: 70,
              url:
                "https://na98.salesforce.com/services/data/v39.0/sobjects/Lead/describe"
            }
          ]),
          [
            "info",
        ...
        messages: [
          {
            ...
            user: {
              ...
              indexed_at: "2017-12-27T18:15:54+00:00",
              "traits_salesforce_lead/deleted_at":
    ...
    return testScenario({ connectorConfig }, ({ handlers, nock, expect }) => {
      return {
        ...
        externalApiMock: () => {
                ...
                records: [
                  {
                    attributes: {
                      type: "Lead",
                      url:
                        "/services/data/v39.0/sobjects/Lead/00Q1I000004WHchAAA"
                    },
                  ...
                  },
                  {
                    attributes: {
                      type: "Lead",
                      url:
                        "/services/data/v39.0/sobjects/Lead/00K5X000008NAchUAG"
                    },
          ...
          const respBody = createSoapEnvelope("updateResponse", {
            result: [{ id: "00Q1I000004WHchAAA", success: "true" }]
          });
          nock("https://na98.salesforce.com")
            .post("/services/Soap/u/39.0")
            .reply(200, respBody, {
