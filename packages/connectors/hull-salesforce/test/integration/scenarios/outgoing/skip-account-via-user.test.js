                  ...
                  records: [
                    ...
                    },
                    {
                      attributes: {
                        type: "Account",
                        url:
                          "/services/data/v39.0/sobjects/Account/1188F000007Cy1CQAS"
                      },
          ...
          externalApiMock: () => {
            ...
            scope
              ...
              .query(query => {
                return (
                  query.q ===
                  "SELECT Website, Name, Mrr__c, CS_Stage__c, Id FROM Account WHERE Website = 'a.com' ORDER BY CreatedDate ASC LIMIT 10000"
                );
              })
              .reply(
                200,
          ...
          logs: [
            ...
            expect.arrayContaining([
              "ship.service_api.request",
              {
                ...
                url_length: 219,
                url:
                  "https://na98.salesforce.com/services/data/v39.0/query?q=SELECT%20Website%2C%20Name%2C%20Mrr__c%2C%20CS_Stage__c%2C%20Id%20FROM%20Account%20WHERE%20Website%20%3D%20'a.com'%20ORDER%20BY%20CreatedDate%20ASC%20LIMIT%2010000"
              }
            ]),
            expect.arrayContaining([
              "ship.service_api.request",
