module.exports = {
      ...
      events_mapping: [
        {
          event: "Sample event",
          activity_type: "Note",
          operation: "properties.event_property"
        }
      ]
    }
  },
  ...
  "serviceRequests": [
    ...
    },
    {
      ...
      input: {
        ident: {
          anonymous_id: "coppercrm-person:person-54459898"
        },
        events: [
          {
            properties: { copper_activity_id: 12345, event_property: "abc" },
            context: expect.objectContaining({ event_id: 4242 }),
