...
it("Receive Webhook - contact deleted payload ", () => {
  return testScenario({ connectorConfig }, ({ handlers, nock, expect }) => {
    return {
      ...
      firehoseEvents: [
        ["traits", { "asUser": { "anonymous_id": "hubspot:123" }, "subjectType": "user" }, { "hubspot/deleted_at": 1567689104280 }],
        ["traits", { "asUser": { "anonymous_id": "hubspot:124" }, "subjectType": "user" }, { "hubspot/deleted_at": 1567689104280 }]
      ],
      metrics: [
