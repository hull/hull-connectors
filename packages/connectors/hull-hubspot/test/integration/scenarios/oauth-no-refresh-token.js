  ...
  return testScenario({ connectorServer, connectorManifest }, ({ handlers, nock, expect }) => {
    return {
      ...
      logs: [
        ...
        ["debug", "access_token", {}, {"expires_at": expect.whatever(), "expires_in": expect.whatever(), "fetched_at": expect.whatever(), "utc_now": expect.whatever(), "will_expire_in": expect.whatever(), "will_expire_soon": true}]
      ],
      firehoseEvents: [],
      metrics: [
