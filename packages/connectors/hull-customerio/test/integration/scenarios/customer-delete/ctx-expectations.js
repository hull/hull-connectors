...
module.exports = (ctxMock) => {
  ...
  expect(_.omit(ctxMock.client.traits.mock.calls[0][0], "customerio/deleted_at")).toEqual({
    "customerio/id": null, "customerio/hash": null, "customerio/synced_at": null, "customerio/created_at": null
  });
  expect(ctxMock.client.traits.mock.calls[0][0]).toHaveProperty("customerio/deleted_at");
