          ...
          connector: {
            private_settings: {
              ...
              incoming_lead_attributes: [
                {
                  service: "email",
                  hull: "traits_intercom_lead/email",
                  overwrite: true
                },
                {
                  service: "name",
                  hull: "traits_intercom_lead/name",
                  overwrite: true
                },
                {
                  service: "phone",
                  hull: "traits_intercom_lead/phone",
                  overwrite: true
                },
                {
                  service: "location.city",
                  hull: "traits_intercom_lead/city",
                  overwrite: true
                }
              ]
            }
          },
          usersSegments: [{ id: "s2", name: "Segment 2" }],
          accountsSegments: [],
          externalApiMock: () => {
            const scope = nock("https://api.intercom.io");

            scope.get("/data_attributes?model=contact").reply(200, {
              type: "list",
              data: []
            });
      ...
      ({ handlers, nock, expect }) => {
        return {
          ...
          externalApiMock: () => {
            ...
            scope.get("/tags").reply(200, {
              type: "list",
              data: [{ type: "tag", id: "tag_id_2", name: "Lead Segment 1" }]
            });

            scope.get("/contacts/5f22f1b6fcaca714eb055739/tags").reply(200, {
              type: "list",
              data: [{ type: "tag", id: "tag_id_2", name: "Lead Segment 1" }]
            });
