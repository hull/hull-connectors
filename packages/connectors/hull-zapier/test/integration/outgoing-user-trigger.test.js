    ...
    return testScenario(
      ...
      ({ handlers, nock, expect }) => {
        const updateMessages = _.cloneDeep(
          require("./fixtures/notifier-payloads/update-single-user")
        );
        ...
        _.set(updateMessages, "messages", [message1]);
        ...
        return _.assign(updateMessages, {
          ...
          externalApiMock: () => {
            const scope = nock(
              "https://hooks.zapier.com/hooks/standard/5687326"
            );

            scope.post("/user-created/1").reply(200, {
              status: "success",
              attempt: "1",
              id: "1",
              request_id: "1"
      ...
      ({ handlers, nock, expect }) => {
        ...
        return _.assign(updateMessages, {
          ...
          externalApiMock: () => {
            ...
            scope.post("/user-entered-segment/1").reply(200, {
              status: "success",
              attempt: "1",
              id: "1",
              request_id: "1"
      ...
      ({ handlers, nock, expect }) => {
        ...
        return _.assign(updateMessages, {
          ...
          externalApiMock: () => {
            ...
            scope.post("/user-left-segment/1").reply(200, {
              status: "success",
              attempt: "1",
              id: "1",
              request_id: "1"
            ...
            [
              ...
              expect.objectContaining({
                data: {
                  ...
                  changes: {
                    segments: {
                      left: [{ id: "user_segment_1", name: "UserSegment1" }]
                    }
                  }
                },
                type: "User"
      ...
      ({ handlers, nock, expect }) => {
        ...
        const private_settings = {
          ...
          triggers: [
            ...
            },
            {
              serviceAction: {
                webhook:
                  "https://hooks.zapier.com/hooks/standard/5687326/user-attribute-updated/2"
              },
              inputData: {
                user_attribute_updated: [
                  "pipedrive/status",
            ...
            },
            {
              serviceAction: {
                webhook:
                  "https://hooks.zapier.com/hooks/standard/5687326/account-attribute-updated/1"
              },
              inputData: {
        ...
        const message1 = {
          changes: {
            ...
            account: {},
            user: {
              "pipedrive/department[0]": ["marketing", "sales"],
              "pipedrive/department[1]": ["engineering", "accounting"],
              blacklistattr_1: ["", "1"],
              blacklistattr_2: ["", "1"],
              blacklistattr_3: ["", "1"]
            },
        ...
        return _.assign(updateMessages, {
          ...
          externalApiMock: () => {
            ...
            scope.post("/user-attribute-updated/1").reply(200, {
              status: "success",
              attempt: "1",
              id: "1",
              request_id: "1"
      ...
      ({ handlers, nock, expect }) => {
        ...
        const private_settings = {
          ...
          triggers: [
            ...
            },
            {
              serviceAction: {
                webhook:
                  "https://hooks.zapier.com/hooks/standard/5687326/user-created/2"
              },
              inputData: {
                is_new_user: true,
            ...
            },
            {
              ...
              inputData: {
                left_user_segments: [
                  "user_segment_1123414",
                  "user_segment_212341234"
                ]
              }
            },
            {
            ...
            },
            {
              serviceAction: {
                webhook:
                  "https://hooks.zapier.com/hooks/standard/5687326/account-attribute-updated"
              },
              inputData: {
                account_attribute_updated: ["pipedrive/industry"],
            ...
            },
            {
              serviceAction: {
                webhook:
                  "https://hooks.zapier.com/hooks/standard/5687326/user-created/3"
              },
              inputData: {
                is_new_user: true,
        ...
        return _.assign(updateMessages, {
          ...
          externalApiMock: () => {
            ...
            scope.post("/user-created/2").reply(200, {
              status: "success",
              attempt: "1",
              id: "1",
              request_id: "1"
          ...
          logs: [
            ...
            [
              ...
              expect.objectContaining({
                data: expect.objectContaining({ message_id: "message_1" }),
                type: "User"
              })
            ],
            [
  ...
  it("Send Multiple Users To Zapier", () => {
    return testScenario(
      ...
      ({ handlers, nock, expect }) => {
        ...
        _.set(updateMessages, "messages", [message1, message2, message3]);
        _.set(updateMessages.connector, "private_settings", private_settings);
        ...
        return _.assign(updateMessages, {
          ...
          logs: [
            ...
            [
              ...
              expect.objectContaining({
                data: expect.objectContaining({ message_id: "message_2" }),
                type: "User"
              })
            ],
            [
              ...
              expect.objectContaining({
                data: expect.objectContaining({ message_id: "message_3" }),
                type: "User"
              })
            ],
            [
