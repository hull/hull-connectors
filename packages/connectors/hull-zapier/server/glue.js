...
const glue = {
  ...
  create: returnValue([
    ...
    ifL(cond("isEqual", "${entityType}", "user"), [
      hull("asUser", jsonata(`$.{"accountIdent": {"external_id": account_claims.account_external_id, "domain": account_claims.account_domain}, "ident": {"external_id": claims.external_id, "email": claims.email}, "attributes": attributes}`, input("body")))
    ]),
