...
test("send batch user update to outreach", () => {
  return testScenario({ connectorServer }, ({ handlers, nock, expect }) => {
    ...
    return _.assign(updateMessages, {
      ...
      logs: [
        ["info", "outgoing.job.start", {}, {"jobName": "Outgoing Data", "type": "user"}],
        ...
        ["debug", "connector.service_api.call", {}, {"method": "PATCH", "responseTime": expect.whatever(), "status": 200, "url": "/prospects/16", "vars": {}}],
        ["debug", "connector.service_api.call", {}, {"method": "GET", "responseTime": expect.whatever(), "status": 200, "url": "/prospects/", "vars": {}}],
        ["info", "outgoing.user.success", {"subject_type": "user", "user_email": "darth@darksideinc.com", "user_id": "5bd329d5e2bcf3eeaf000099"}, expect.objectContaining({"type": "Prospect"})],
        ["debug", "connector.service_api.call", {}, {"method": "POST", "responseTime": expect.whatever(), "status": 200, "url": "/prospects/", "vars": {}}],
        ["info", "outgoing.user.success", {"subject_type": "user", "user_email": "fettisbest@gmail.com", "user_id": expect.whatever()}, expect.objectContaining({"type": "Prospect"})],
        ["info", "incoming.user.success", {}, {"data": {"attributes": {"outreach/id": {"operation": "set", "value": 16}, "outreach/personalNote1": {"operation": "set", "value": "sith lord, don't mention padme"}}, "ident": {"anonymous_id": "outreach:16", "email": "darth@darksideinc.com"}}}],
        ["info", "incoming.user.success", {}, {"data": {"attributes": {"outreach/id": {"operation": "set", "value": 16}, "outreach/personalNote1": {"operation": "set", "value": "sith lord, don't mention padme"}}, "ident": {"anonymous_id": "outreach:16", "email": "darth@darksideinc.com"}}}],
        ["info", "outgoing.job.success", {}, {"jobName": "Outgoing Data", "type": "user"}]
      ],
      // same received user because we're mocking the return of bobba with a different user
      firehoseEvents: [
        ["traits", {"asUser": {"anonymous_id": "outreach:16", "email": "darth@darksideinc.com"}, "subjectType": "user"}, {"outreach/id": {"operation": "set", "value": 16}, "outreach/personalNote1": {"operation": "set", "value": "sith lord, don't mention padme"}}],
        ["traits", {"asUser": {"anonymous_id": "outreach:16", "email": "darth@darksideinc.com"}, "subjectType": "user"}, {"outreach/id": {"operation": "set", "value": 16}, "outreach/personalNote1": {"operation": "set", "value": "sith lord, don't mention padme"}}]
      ],
      metrics: [
      ...
      platformApiCalls: [
        ["GET", "/_users_batch", {}, {}],
        ["GET", "/api/v1/app", {}, {}],
        ["PUT", "/api/v1/9993743b22d60dd829001999", {}, {"private_settings": {"access_token": "1234", "account_claims": [{"hull": "domain", "service": "domain"}, {"hull": "external_id", "service": "customId"}], "incoming_account_attributes": [{"hull": "traits_outreach/custom1", "service": "custom1"}, {"hull": "traits_outreach/custom10", "service": "custom10"}], "incoming_user_attributes": [{"hull": "traits_outreach/custom1", "service": "custom1"}, {"hull": "traits_outreach/personalNote1", "service": "personalNote1"}], "user_claims": [{"hull": "email", "service": "emails"}, {"hull": "external_id", "service": "externalId"}], "webhook_id": 3}}]]
    });
  });
});
