  ...
  return testScenario({ connectorConfig }, ({ handlers, nock, expect }) => {
    ...
    return _.assign(updateMessages, {
      ...
      logs: [
        ...
        ["error", "outgoing.account.skip", {"account_domain": "afterlife.com", "account_id": "5c0fd68ad884b4373800011a", "request_id": expect.whatever(), "subject_type": "account"}, { "data": expect.whatever(), "type": "Account", "error": "Outreach has rejected the objects being sent, please review attributes that you have in your filters to make sure that you've selected all the fields that outreach requires, if you think this is correct, please contact Hull support"}],
