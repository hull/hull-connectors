  ...
  return testScenario({ connectorServer, debounceWait: 1000 }, ({ handlers, nock, expect }) => {
    return {
      ...
      externalApiMock: () => {
        ...
        const listOfProspects = _.cloneDeep(require("../fixtures/api-responses/list-accounts-template.json"));
        ...
        scope
          .get("/api/v2/prospects/?sort=id&page[limit]=100&filter[id]=101..inf")
