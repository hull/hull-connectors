  ...
  return testScenario({ manifest, connectorConfig }, ({ handlers, nock, expect }) => {
    ...
    return _.assign(updateMessages, {
      ...
      logs: [
        ...
        ["debug", "outgoing.user.skip", {"request_id": expect.whatever(), "subject_type": "user", "user_email": "fettisbest@gmail.com", "user_id": "5bd329d5e2bcf3eeaf00009f"}, {"reason": "User is not present in any of the defined segments to send to service.  Please either add a new synchronized segment which the user is present in the settings page, or add the user to an existing synchronized segment"}],
