module.exports = {
  configuration: {
    ...
    private_settings: {
      ...
      prospect_outgoing_user_segments: "tags",
      prospect_outgoing_account_segments: "custom1"
    }
  },
  route: "userUpdate",
  input: {
  ...
  serviceRequests: [
    {
      ...
      input: {
        data: {
          ...
          id: 184849,
          attributes: {
            tags: expect.arrayContaining(["Send Leads To Intercom"]),
            custom1: `["Send Accounts To Intercom"]`,
            title: "ceo"
          }
        }
      },
    ...
    },
    {
      ...
      input: {
        data: {
          ...
          id: 184850,
          attributes: {
            tags: expect.arrayContaining(["Users with email", "Send Leads To Intercom"]),
            custom1: "[\"Accounts With Email\",\"Send Accounts To Intercom\"]",
            title: "cto"
          }
        }
      },
