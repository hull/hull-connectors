...
//    */
//   const notifications = {
//     "user:update": (ctx: HullContext, messages: Array<HullUserUpdateMessage>) => hullRouter.outgoingData("user", ctx, messages),
//     "account:update": (ctx: HullContext, messages: Array<HullAccountUpdateMessage>) => hullRouter.outgoingData("account", ctx, messages)
//   };
//
//   app.use(
//     "/webhooks",
...
//     callback: (req: HullRequest): Promise<any> => hullRouter.status(req)
//   });
//
