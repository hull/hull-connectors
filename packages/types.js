...
} from "./hull-client-types";
import type HullInstrumentation from "./hull/src/infra/instrumentation/instrumentation-agent";
import type HullCache from "./hull/src/infra/cache/cache-agent";
import type HullQueue from "./hull/src/infra/queue/queue-agent";

export type * from "hull-client";

const Client = require("hull-client");

const ConnectorCache = require("./hull/src/infra/cache/connector-cache");
const MetricAgent = require("./hull/src/infra/instrumentation/metric-agent");

export type Cache = HullCache;
export type Queue = HullQueue;
export type Instrumentation = HullInstrumentation;
...
export type HullContextBaseMiddlewareParams = {
  requestName?: string,
  HullClient: Class<Client>,
 ...
 * @memberof Types
 */
declare class HullExpressRequest extends $Request {
